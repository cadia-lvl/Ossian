...
def store_network(nnets_file_name, lab_dim, outdir):
    ...
    # Copy keras model to voice directory
    model_paths = [nnets_file_name + '.h5', nnets_file_name + '.json',]
    for mpath in model_paths:
        fname = mpath.split('/')[-1]
        copyfile(mpath, os.path.join(outdir, fname))

    # DNN_tanh_tanh_tanh_LINEAR__dur_0_3_512_512_512_341.5.train.139.0.002000.rnn.model
